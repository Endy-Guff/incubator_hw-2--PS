...
export function Todolist(props: PropsType) {
    ...
    function filterFirstThreeTasks(){
        let filteredTasks = props.tasks.filter(t => t.id === 1 || t.id === 2 || t.id === 3)
    ...
    return <div>
        ...
        <div>
            ...
            <button onClick={()=>filterFirstThreeTasks()}>
                First 3 tasks
            </button>
        </div>
    </div>
